    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-gray-900 to-black flex items-center justify-center p-4">
      <div className="max-w-2xl w-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Seed Admin Account</h1>
          <p className="text-gray-400">Create a super admin account for LyFind</p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-300">
              ...
              <ul className="list-disc list-inside space-y-1 text-blue-200">
                ...
                <li>Role: Super Admin with all permissions</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-orange-300">
              ...
              <p className="text-orange-200">Change the password immediately after first login!</p>
            </div>
          </div>
        </div>
              ...
              <div className="flex-1">
                ...
                {result.success && result.uid && (
                  <div className="mt-3 p-3 bg-black/20 rounded-lg">
                    <p className="text-xs text-gray-400 mb-1">Admin UID:</p>
                    <p className="text-sm font-mono text-white break-all">{result.uid}</p>
                  </div>
                )}
              </div>
            </div>
