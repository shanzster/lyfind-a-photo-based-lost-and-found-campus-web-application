    ...
    <main className="min-h-screen pt-24 flex items-center justify-center px-6">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-normal text-white mb-2">Faculty Portal</h1>
          <div className="flex items-center justify-center gap-2 text-white/60">
            <GraduationCap className="w-5 h-5" />
            <span>Lyceum of Subic Bay</span>
          </div>
        </div>
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Email */}
            <div>
              <label className="block text-white/70 text-sm mb-2">Faculty Email</label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="faculty@lsb.edu.ph"
                  required
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/faculty/forgot-password" className="text-[#ff7400] hover:text-[#ff8500] text-sm transition-colors">
                Forgot password?
              </Link>
            </div>
